...
export interface RoleFilterCardProps {
    type: string;
    label: string;
    icon: any;
    colorClass: string;
...
const RoleFilterCard: React.FC<RoleFilterCardProps> = ({ type, label, icon: Icon, colorClass, activeColorClass, count, isActive, onClick }) => {
    return (
      <motion.button
