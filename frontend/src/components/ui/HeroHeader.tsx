...
const HeroHeader: React.FC<{ title: string; subtitle: string; icon: any; gradient: string; decorativeIcon?: any }> = ({ title, subtitle, icon: Icon, gradient, decorativeIcon: DecorativeIcon }) => {
